...
type: side
source: https://github.com/mt-shihab26/invoice-manager
technologies: ["Laravel", "React", "Inertia.js", "TailwindCSS", "shadcn/ui", "Stripe", "MySQL"]
...
Invoice Manager is a production-grade multi-tenant SaaS application built with Laravel, React, and Inertia.js. It enables freelancers and small businesses to manage their entire invoicing workflow — from client management to payment collection — in one place.
...
Browse the source at [github.com/mt-shihab26/invoice-manager](https://github.com/mt-shihab26/invoice-manager)
