...
const NeovimIcon: TIcon = (props) => {
    return (
        ...
        >
            ...
            />
            <path
                d="m764 318.25-90.4 346.95-289-296.4-133 323.2 291.15 291.15q3.17636719-.17363281 6.3-.4 30.05-2.15 58.7-7.7 11.8-2.3 23.4-5.15 120.6-30.05 214.65-124.1 72.9-72.95 107.35-161.8 26.534375-68.46328125 30.25-146.35z"
                fillOpacity=".098039"
            />
            <path d="m644.7 583.7v242.25l95.45-96.2z" fill="#74b56a" />
            <path d="m389.05 442.6v-250.05l-100.05 100.05z" fill="#6aa662" />
            <path
                d="m644.7 583.7-6.65-10.2-249-380.95v250.05l1.55 2.35 254.1 381z"
                fill="#87d37c"
            />
