...
export const PocketBaseIcon: TIcon = props => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 40 40" {...props}>
            ...
            <path
                fill="#fff"
                d="M26 14h10.8a1.2 1.2 0 0 1 1.2 1.2v21.6a1.2 1.2 0 0 1-1.2 1.2H15.2a1.2 1.2 0 0 1-1.2-1.2V26"
            />
            <path
                stroke="#16161a"
                strokeLinecap="round"
            ...
            <path
                fill="#fff"
                d="M26 14V3.2A1.2 1.2 0 0 0 24.8 2H3.2A1.2 1.2 0 0 0 2 3.2v21.6A1.2 1.2 0 0 0 3.2 26H14"
            />
            <path
                stroke="#16161a"
                strokeLinecap="round"
