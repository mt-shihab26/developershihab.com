        ...
        <section className="space-y-3">
            ...
            <div className="space-y-2 leading-relaxed">
                <p>
                    ...
                    <span className="font-medium">full-stack development</span> and building <span className="font-medium">scalable software solutions</span>.
                ...
                <p>
                    ...
                    <span className="font-medium">PHP, Laravel, JavaScript/TypeScript, React, TailwindCSS, and WordPress</span>.
                    Experienced in delivering <span className="font-medium">end-to-end solutions</span>, from conception to{" "}
                    <span className="font-medium">cloud deployment</span>, with a strong focus on rapid development and{" "}
                ...
                <p>
                    ...
                    <span className="font-medium">1,000 problems solved</span> on online coding platforms. Experienced in collaborating with
