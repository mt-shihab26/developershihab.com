...
const Item = ({ pathname, href, children }: { pathname: string; href: string; children: ReactNode }) => {
...
const DesktopNavigation = ({ className, pathname, ...props }: { className?: string; pathname: string }) => {
    return (
